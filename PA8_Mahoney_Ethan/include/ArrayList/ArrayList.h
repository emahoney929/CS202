...
class ArrayList{
  ...
  friend std::ostream & operator<<(std::ostream & os, const ArrayList & arrayList);	//(i)
  ...
  public:
    ...
    DataType * find(const DataType & target, DataType * & previous, const DataType * start = nullptr);         //(8)
